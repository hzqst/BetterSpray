...
class IBaseSprayQuery : public IBaseInterface
{
public:
...
{
public:
	virtual void OnEnumQuery(IBaseSprayQuery* pQuery) = 0;
};

class ISprayQueryStateChangeHandler : public IBaseInterface
{
public:
	virtual void OnQueryStateChanged(IBaseSprayQuery* pQuery, SprayQueryState newState) = 0;
};
...
public:
	...
	virtual void DispatchQueryStateChangeCallback(IBaseSprayQuery* pQuery, SprayQueryState newState) = 0;
};
