...
#define EXPOSE_INTERFACE_FN(functionName, interfaceName, versionName) \
    static InterfaceReg __g_Create##functionName##_reg(functionName, versionName);
...
// Only define CreateInterface here if the plugin didn't already define it
#if !defined(CUSTOM_CREATEINTERFACE_DEFINED)
extern "C"
{
